...
![PayBridge architecture — Cloud Scheduler triggers a Cloud Run agent that checks Paystack, Firestore, and Vertex AI, then escalates unresolved payments to Twilio WhatsApp](architecture.png)
